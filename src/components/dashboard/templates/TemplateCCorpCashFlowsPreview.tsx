...
const TemplateCCorpCashFlowsPreview = ({ isEditMode = false }: { isEditMode?: boolean }) => {
  ...
  const rows: Row[] = [
    ...
    { label: "Net Income", col1: "226,000", col2: "160,000" },
    { label: "Adjustments to reconcile net income to net cash:", col1: "", col2: "", bold: true },
    { label: "Depreciation and Amortization", col1: "47,000", col2: "42,000", indent: 1 },
    { label: "Deferred Income Taxes", col1: "7,000", col2: "5,000", indent: 1 },
    { label: "Gain on Sale of Assets", col1: "(8,000)", col2: "-", indent: 1 },
    ...
    { label: "Prepaid Expenses", col1: "(4,000)", col2: "2,000", indent: 2 },
    { label: "Accounts Payable", col1: "24,000", col2: "15,000", indent: 2 },
    { label: "Accrued Expenses", col1: "13,000", col2: "8,000", indent: 2 },
    { label: "Income Taxes Payable", col1: "4,000", col2: "3,000", indent: 2, bottomBorder: true },
    { label: "Net Cash Provided by Operating Activities", col1: "254,000", col2: "195,000", bold: true, topBorder: true, bottomBorder: true, thick: true, isTotal: true },

    { label: "Cash Flows from Investing Activities", col1: "", col2: "", bold: true, topBorder: true },
    { label: "Purchases of Property, Plant and Equipment", col1: "(30,000)", col2: "(45,000)", indent: 1 },
    { label: "Proceeds from Sale of Assets", col1: "15,000", col2: "-", indent: 1 },
    { label: "Purchases of Intangible Assets", col1: "(5,000)", col2: "(8,000)", indent: 1, bottomBorder: true },
    { label: "Net Cash Used in Investing Activities", col1: "(20,000)", col2: "(53,000)", bold: true, topBorder: true, bottomBorder: true, thick: true, isTotal: true },
    ...
    { label: "Dividends Paid", col1: "(180,000)", col2: "(80,000)", indent: 1 },
    { label: "Proceeds from Issuance of Common Stock", col1: "-", col2: "10,000", indent: 1, bottomBorder: true },
    { label: "Net Cash Used in Financing Activities", col1: "(205,000)", col2: "(95,000)", bold: true, topBorder: true, bottomBorder: true, thick: true, isTotal: true },

    { label: "Net Increase (Decrease) in Cash and Cash Equivalents", col1: "29,000", col2: "47,000", bold: true, topBorder: true, isTotal: true },
    { label: "Cash and Cash Equivalents, Beginning of Year", col1: "98,000", col2: "51,000", bold: true },
    { label: "Cash and Cash Equivalents, End of Year", col1: "127,000", col2: "98,000", bold: true, topBorder: true, bottomBorder: true, thick: true, isTotal: true },
  ];
      ...
      >
        ...
        <div style={{ flex: 1, padding: bodyPadding, fontSize: baseFontSize, color: "#1a1a1a", position: "relative" }}>
          ...
          <div style={{ marginTop: 24 }}>
            <div style={{ fontWeight: 700, marginBottom: 6 }}>Supplemental Disclosures of Cash Flow Information</div>
            <table style={{ width: "100%", borderCollapse: "collapse", fontSize: baseFontSize }}>
              <tbody>
                <tr>
                ...
                <tr>
                  <td className={labelStyle} style={{ paddingLeft: 16 }}>Cash Paid for Income Taxes</td>
                  <td className={cellStyle} style={{ width: "22.5%", fontWeight: 700 }}>{fv("64,000")}</td>
                  <td className={cellStyle} style={{ width: "22.5%" }}>{fv("45,000")}</td>
                </tr>
              </tbody>
            </table>
          </div>
...
export default TemplateCCorpCashFlowsPreview;
