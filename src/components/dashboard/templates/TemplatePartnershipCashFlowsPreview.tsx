...
const TemplatePartnershipCashFlowsPreview = ({ isEditMode = false }: { isEditMode?: boolean }) => {
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: baseFontSize }}>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className={cellStyle}>{fvRow("79,500")}</td>
              </tr>
              ...
              {[
                { label: "Amortization of Capital Assets", col1: "10,000", col2: "9,500" },
              ].map((r, i) => (
                <tr key={`adj-${i}`}>
              ...
              {[
                ...
                { label: "Prepaid Expenses", col1: "(700)", col2: "400" },
              ...
              <tr>
                ...
                <td className={`${cellStyle} ${thickBorderTop} ${thickBorderBottom}`} style={{ fontWeight: 700 }}>{fv("104,000", false, true)}</td>
                <td className={`${cellStyle} ${thickBorderTop} ${thickBorderBottom}`}>{fv("86,500", false, true)}</td>
              </tr>
              ...
              <tr>
                ...
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fv("13,000", false, true)}</td>
                <td className={cellStyle}>{fv("1,500", false, true)}</td>
              </tr>
              <tr>
                ...
                <td className={`${cellStyle}`}>{fvRow("30,500")}</td>
              </tr>
              <tr>
                <td className={`${labelStyle} ${thickBorderTop} ${thickBorderBottom}`} style={{ fontWeight: 700 }}>Cash and Cash Equivalents, End of Year</td>
                <td className={`${cellStyle} ${thickBorderTop} ${thickBorderBottom}`} style={{ fontWeight: 700 }}>{fv("45,000", false, true)}</td>
...
export default TemplatePartnershipCashFlowsPreview;
