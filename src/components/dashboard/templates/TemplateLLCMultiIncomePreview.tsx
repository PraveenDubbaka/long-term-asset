...
const TemplateLLCMultiIncomePreview = ({ isEditMode = false }: { isEditMode?: boolean }) => {
        ...
        <div style={{ flex: 1, padding: bodyPadding, fontSize: baseFontSize, color: "#1a1a1a", position: "relative" }}>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: baseFontSize }}>
            ...
            <tbody>
              ...
              {/* Cost of Sales */}
              <tr><td className={labelStyle} style={{ fontWeight: 700 }}>Cost of Sales</td><td className={cellStyle}></td><td className={cellStyle}></td>{emptyManualTd}</tr>
              {[
              ...
              {[
                ...
                { label: "Amortization (Note 3)", col1: "12,000", col2: "10,800" },
                { label: "Interest on Long-Term Debt", col1: "4,300", col2: "5,200" },
                { label: "Other Expenses", col1: "2,500", col2: "1,800" },
              ].map((r, i, arr) => (
                <tr key={`exp-${i}`}>
                  <td className={`${labelStyle} ${i === arr.length - 1 ? borderBottom : ""}`} style={{ paddingLeft: 16 }}>{r.label}</td>
                  <td className={`${cellStyle} ${i === arr.length - 1 ? borderBottom : ""}`} style={{ fontWeight: 700 }}>{fvRow(r.col1)}</td>
              ...
              <tr>
                ...
                <td className={`${cellStyle} ${thickBorderTop}`} style={{ fontWeight: 700 }}>{fv("150,700", false, true)}</td>
                <td className={`${cellStyle} ${thickBorderTop}`}>{fv("137,200", false, true)}</td>
              </tr>
              ...
              <tr>
                ...
                <td className={`${cellStyle} ${thickBorderTop} ${thickBorderBottom}`} style={{ fontWeight: 700 }}>{fv("68,800", false, true)}</td>
                <td className={`${cellStyle} ${thickBorderTop} ${thickBorderBottom}`}>{fv("54,000", false, true)}</td>
              </tr>
              ...
              {[
                { label: "Member A (55%)", col1: "37,840", col2: "29,700" },
                { label: "Member B (45%)", col1: "30,960", col2: "24,300" },
              ].map((r, i, arr) => (
                <tr key={`alloc-${i}`}>
                  <td className={`${labelStyle} ${i === arr.length - 1 ? borderBottom : ""}`} style={{ paddingLeft: 16 }}>{r.label}</td>
                  <td className={`${cellStyle} ${i === arr.length - 1 ? borderBottom : ""}`} style={{ fontWeight: 700 }}>{fvRow(r.col1)}</td>
...
export default TemplateLLCMultiIncomePreview;
