...
const TemplateLLCMultiNotesPreview = ({ isEditMode = false }: { isEditMode?: boolean }) => {
    ...
    <div className="flex-1 flex flex-col items-center gap-8 p-6 bg-muted/30 overflow-y-auto">
      <div ref={pageRef} style={pageStyle}>
        ...
        <div style={bodyStyle}>
          ...
          {/* Note 1 */}
          {sectionTitle("1", "Nature of the Organization")}
          <p style={{ fontSize: baseFontSize, marginBottom: 8, textAlign: "justify" }}>
            ABC Company LLC is a limited liability company organized under the laws of the Province of [Province]. The company is engaged in [description of business activities]. The operating agreement provides for the allocation of net income and losses between members based on agreed profit and loss sharing ratios.
          </p>
          ...
          <p style={{ fontSize: baseFontSize, marginBottom: 6, textAlign: "justify", paddingLeft: 8 }}>
            Service revenue is recognized when services are rendered and collection is reasonably assured. Product sales are recognized at the point of delivery when the significant risks and rewards of ownership have been transferred to the buyer.
          </p>
          <div style={{ fontWeight: 700, fontSize: baseFontSize * 0.95, marginTop: 8, marginBottom: 4 }}>Inventory</div>
          <p style={{ fontSize: baseFontSize, marginBottom: 6, textAlign: "justify", paddingLeft: 8 }}>
          ...
          <p style={{ fontSize: baseFontSize, marginBottom: 6, textAlign: "justify", paddingLeft: 8 }}>
            As a limited liability company, the entity is not subject to income tax. The members are individually responsible for income tax on their respective shares of the company's income, as allocated per the operating agreement.
          </p>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: baseFontSize }}>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className={`${cellStyle} ${thickBorderTop} ${thickBorderBottom}`} style={{ fontWeight: 700 }}>103,000</td>
              </tr>
            </tbody>
          </table>
          ...
          <p style={{ fontSize: baseFontSize, marginBottom: 8, textAlign: "justify" }}>
            During the year, guaranteed payments totalling $12,000 (20XX — $10,000) were made to Members A and B for management services rendered. These transactions were measured at the exchange amount, which is the amount of consideration established and agreed to by the related parties.
          </p>

          {/* Note 6 */}
          {sectionTitle("6", "Operating Agreement")}
          <p style={{ fontSize: baseFontSize, marginBottom: 8, textAlign: "justify" }}>
...
export default TemplateLLCMultiNotesPreview;
