...
const TemplatePartnershipBalanceSheetPreview = ({ isEditMode = false }: { isEditMode?: boolean }) => {
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: baseFontSize }}>
            ...
            <tbody>
              ...
              {[
                ...
                { label: "Accounts Receivable", col1: "38,500", col2: "27,800" },
                { label: "Prepaid Expenses", col1: "4,200", col2: "3,500" },
              ].map((r, i, arr) => (
                <tr key={i}>
              ...
              <tr>
                ...
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fv("87,700", false, true)}</td>
                <td className={cellStyle}>{fv("63,300", false, true)}</td>
              </tr>
              ...
              {[
                { label: "Property and Equipment", col1: "120,000", col2: "110,000" },
                { label: "Less: Accumulated Amortization", col1: "(35,000)", col2: "(25,000)" },
              ].map((r, i, arr) => (
                <tr key={`ca-${i}`}>
                  <td className={`${labelStyle} ${i === arr.length - 1 ? borderBottom : ""}`} style={{ paddingLeft: 32 }}>{r.label}</td>
                  <td className={`${cellStyle} ${i === arr.length - 1 ? borderBottom : ""}`} style={{ fontWeight: 700 }}>{fvRow(r.col1)}</td>
              ...
              <tr>
                ...
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fv("85,000", false, true)}</td>
                <td className={cellStyle}>{fv("85,000", false, true)}</td>
              </tr>
              ...
              <tr>
                ...
                <td className={`${cellStyle} ${thickBorderTop} ${thickBorderBottom}`} style={{ fontWeight: 700 }}>{fv("172,700", false, true)}</td>
                <td className={`${cellStyle} ${thickBorderTop} ${thickBorderBottom}`}>{fv("148,300", false, true)}</td>
              </tr>
              ...
              {/* PARTNERS' CAPITAL */}
              <tr><td className={labelStyle} style={{ fontWeight: 700 }}>Partners' Capital</td><td className={cellStyle}></td><td className={cellStyle}></td>{emptyManualTd}</tr>
              {[
                { label: "Partner A — Capital Account", col1: "52,000", col2: "38,000" },
                { label: "Partner B — Capital Account", col1: "42,000", col2: "29,000" },
              ].map((r, i, arr) => (
                <tr key={`eq-${i}`}>
                  <td className={`${labelStyle} ${i === arr.length - 1 ? borderBottom : ""}`} style={{ paddingLeft: 16 }}>{r.label}</td>
                  <td className={`${cellStyle} ${i === arr.length - 1 ? borderBottom : ""}`} style={{ fontWeight: 700 }}>{fvRow(r.col1)}</td>
              ...
              <tr>
                <td className={labelStyle} style={{ fontWeight: 700 }}>Total Partners' Capital</td>
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fv("94,000", false, true)}</td>
                <td className={cellStyle}>{fv("67,000", false, true)}</td>
              </tr>
...
export default TemplatePartnershipBalanceSheetPreview;
