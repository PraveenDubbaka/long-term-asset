...
const TemplatePartnershipTaxIncomePreview = ({ isEditMode = false }: { isEditMode?: boolean }) => {
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: baseFontSize }}>
            ...
            <tbody>
              ...
              {[
                ...
                { label: "Meals and Entertainment (50%)", col1: "1,200", col2: "900" },
                { label: "Motor Vehicle Expenses (Tax Portion)", col1: "3,800", col2: "3,200" },
              ].map((r, i, arr) => (
                <tr key={`exp-${i}`}>
                  <td className={`${labelStyle} ${i === arr.length - 1 ? borderBottom : ""}`} style={{ paddingLeft: 16 }}>{r.label}</td>
                  <td className={`${cellStyle} ${i === arr.length - 1 ? borderBottom : ""}`} style={{ fontWeight: 700 }}>{fvRow(r.col1)}</td>
              ...
              <tr>
                ...
                <td className={`${cellStyle} ${thickBorderTop}`} style={{ fontWeight: 700 }}>{fv("131,200", false, true)}</td>
                <td className={`${cellStyle} ${thickBorderTop}`}>{fv("121,300", false, true)}</td>
              </tr>
              ...
              <tr>
                ...
                <td className={`${cellStyle} ${thickBorderTop} ${thickBorderBottom}`} style={{ fontWeight: 700 }}>{fv("99,300", false, true)}</td>
                <td className={`${cellStyle} ${thickBorderTop} ${thickBorderBottom}`}>{fv("78,500", false, true)}</td>
              </tr>
              ...
              {[
                { label: "Partner A (60%)", col1: "59,580", col2: "47,100" },
                { label: "Partner B (40%)", col1: "39,720", col2: "31,400" },
              ].map((r, i, arr) => (
                <tr key={`alloc-${i}`}>
                  <td className={`${labelStyle} ${i === arr.length - 1 ? borderBottom : ""}`} style={{ paddingLeft: 16 }}>{r.label}</td>
                  <td className={`${cellStyle} ${i === arr.length - 1 ? borderBottom : ""}`} style={{ fontWeight: 700 }}>{fvRow(r.col1)}</td>
...
export default TemplatePartnershipTaxIncomePreview;
