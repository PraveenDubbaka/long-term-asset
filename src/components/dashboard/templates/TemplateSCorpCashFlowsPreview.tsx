...
const TemplateSCorpCashFlowsPreview = ({ isEditMode = false }: { isEditMode?: boolean }) => {
  ...
  const rows: Row[] = [
    ...
    { label: "Net Income", col1: "109,000", col2: "61,500" },
    { label: "Adjustments to reconcile net income to net cash:", col1: "", col2: "", bold: true },
    { label: "Depreciation and Amortization", col1: "32,000", col2: "28,000", indent: 1 },
    ...
    { label: "Prepaid Expenses", col1: "(2,000)", col2: "1,000", indent: 2 },
    ...
    { label: "Net Cash Provided by Operating Activities", col1: "121,000", col2: "78,500", bold: true, topBorder: true, bottomBorder: true, thick: true, isTotal: true },
    ...
    { label: "Net Cash Used in Investing Activities", col1: "(23,000)", col2: "(32,000)", bold: true, topBorder: true, bottomBorder: true, thick: true, isTotal: true },
    ...
    { label: "Net Increase (Decrease) in Cash", col1: "23,000", col2: "(3,500)", bold: true, topBorder: true, isTotal: true },
    { label: "Cash and Cash Equivalents, Beginning of Year", col1: "78,000", col2: "81,500", bold: true },
    { label: "Cash and Cash Equivalents, End of Year", col1: "101,000", col2: "78,000", bold: true, topBorder: true, bottomBorder: true, thick: true, isTotal: true },
  ];
        ...
        <div style={{ flex: 1, padding: bodyPadding, fontSize: baseFontSize, color: "#1a1a1a", position: "relative" }}>
          ...
          <div style={{ marginTop: 24 }}>
            ...
            <div style={{ fontSize: baseFontSize * 0.9, fontStyle: "italic", marginTop: 6, paddingLeft: 8 }}>
              Note: As a pass-through entity, the S-Corporation does not pay federal income taxes at the entity level.
            </div>
          </div>
        </div>
...
export default TemplateSCorpCashFlowsPreview;
