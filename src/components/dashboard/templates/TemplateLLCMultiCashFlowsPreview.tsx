...
const TemplateLLCMultiCashFlowsPreview = ({ isEditMode = false }: { isEditMode?: boolean }) => {
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: baseFontSize }}>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fvRow("68,800")}</td>
                <td className={cellStyle}>{fvRow("54,000")}</td>
              </tr>
              ...
              {[
                { label: "Amortization of Capital Assets", col1: "12,000", col2: "10,800" },
              ].map((r, i) => (
                <tr key={`adj-${i}`}>
              ...
              {[
                ...
                { label: "Prepaid Expenses", col1: "(600)", col2: "300" },
              ...
              <tr>
                ...
                <td className={`${cellStyle} ${thickBorderTop} ${thickBorderBottom}`} style={{ fontWeight: 700 }}>{fv("77,000", false, true)}</td>
              ...
              {[
                ...
                { label: "Member Drawings / Distributions", col1: "(40,000)", col2: "(32,000)" },
              ...
              <tr>
                ...
                <td className={`${cellStyle} ${thickBorderTop} ${thickBorderBottom}`}>{fv("(42,000)", false, true)}</td>
              </tr>
              ...
              <tr>
                ...
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fv("14,000", false, true)}</td>
              ...
              <tr>
                ...
                <td className={cellStyle}>{fvRow("38,500")}</td>
              </tr>
              <tr>
                <td className={`${labelStyle} ${thickBorderTop} ${thickBorderBottom}`} style={{ fontWeight: 700 }}>Cash and Cash Equivalents, End of Year</td>
                <td className={`${cellStyle} ${thickBorderTop} ${thickBorderBottom}`} style={{ fontWeight: 700 }}>{fv("52,000", false, true)}</td>
...
export default TemplateLLCMultiCashFlowsPreview;
