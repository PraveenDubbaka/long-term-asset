...
const TemplatePartnershipTaxBalanceSheetPreview = ({ isEditMode = false }: { isEditMode?: boolean }) => {
      ...
      >
        ...
        <div style={{ flex: 1, padding: bodyPadding, fontSize: baseFontSize, color: "#1a1a1a", position: "relative" }}>
          <div style={{ marginBottom: 18 }}>
            ...
            <div style={{ fontSize: 18 * scale, fontWeight: 700, marginBottom: 2 }}>
              <span style={{ background: isEditMode ? "hsl(220 15% 90%)" : "transparent", padding: "1px 6px", borderRadius: 2 }}>Statement of Assets, Liabilities, and Partners' Capital — Income Tax Basis</span>
            </div>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: baseFontSize }}>
            ...
            <tbody>
              ...
              {[
                { label: "Cash and Cash Equivalents", col1: "45,000", col2: "32,000" },
                { label: "Accounts Receivable (Tax Basis)", col1: "38,500", col2: "27,800" },
                { label: "Prepaid Expenses (Tax Deductible Portion)", col1: "2,800", col2: "2,100" },
              ].map((r, i, arr) => (
                <tr key={i}>
              ...
              <tr>
                ...
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fv("86,300", false, true)}</td>
                <td className={cellStyle}>{fv("61,900", false, true)}</td>
              </tr>
              ...
              {[
                { label: "Property and Equipment — at Cost", col1: "120,000", col2: "110,000" },
                { label: "Less: Accumulated CCA", col1: "(42,000)", col2: "(30,000)" },
              ].map((r, i, arr) => (
                <tr key={`ca-${i}`}>
                  <td className={`${labelStyle} ${i === arr.length - 1 ? borderBottom : ""}`} style={{ paddingLeft: 32 }}>{r.label}</td>
                  <td className={`${cellStyle} ${i === arr.length - 1 ? borderBottom : ""}`} style={{ fontWeight: 700 }}>{fvRow(r.col1)}</td>
              ...
              <tr>
                ...
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fv("78,000", false, true)}</td>
                <td className={cellStyle}>{fv("80,000", false, true)}</td>
              </tr>
              ...
              <tr>
                ...
                <td className={`${cellStyle} ${thickBorderTop} ${thickBorderBottom}`} style={{ fontWeight: 700 }}>{fv("164,300", false, true)}</td>
                <td className={`${cellStyle} ${thickBorderTop} ${thickBorderBottom}`}>{fv("141,900", false, true)}</td>
              </tr>
              ...
              {[
                { label: "Accounts Payable and Accrued Liabilities", col1: "22,500", col2: "18,200" },
                { label: "Current Portion of Long-Term Debt", col1: "8,000", col2: "8,000" },
                { label: "GST/HST Payable", col1: "3,200", col2: "2,100" },
              ].map((r, i, arr) => (
                <tr key={`cl-${i}`}>
                  <td className={`${labelStyle} ${i === arr.length - 1 ? borderBottom : ""}`} style={{ paddingLeft: 32 }}>{r.label}</td>
                  <td className={`${cellStyle} ${i === arr.length - 1 ? borderBottom : ""}`} style={{ fontWeight: 700 }}>{fvRow(r.col1)}</td>
              ...
              <tr>
                ...
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fv("33,700", false, true)}</td>
                <td className={cellStyle}>{fv("28,300", false, true)}</td>
              </tr>

              <tr><td style={{ height: 4 }}></td><td></td><td></td>{showManual && <td></td>}</tr>

              {[
                { label: "Long-Term Debt (Note 4)", col1: "45,000", col2: "53,000" },
              ].map((r, i, arr) => (
                <tr key={`ltl-${i}`}>
              ...
              <tr>
                ...
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fv("78,700", false, true)}</td>
                <td className={cellStyle}>{fv("81,300", false, true)}</td>
              </tr>

              <tr><td style={{ height: 8 }}></td><td></td><td></td>{showManual && <td></td>}</tr>

              {/* PARTNERS' CAPITAL */}
              <tr><td className={labelStyle} style={{ fontWeight: 700 }}>Partners' Capital — Income Tax Basis</td><td className={cellStyle}></td><td className={cellStyle}></td>{emptyManualTd}</tr>
              {[
                { label: "Partner A — Capital Account (Tax Basis)", col1: "48,000", col2: "34,500" },
                { label: "Partner B — Capital Account (Tax Basis)", col1: "37,600", col2: "26,100" },
              ].map((r, i, arr) => (
                <tr key={`eq-${i}`}>
                  <td className={`${labelStyle} ${i === arr.length - 1 ? borderBottom : ""}`} style={{ paddingLeft: 16 }}>{r.label}</td>
                  <td className={`${cellStyle} ${i === arr.length - 1 ? borderBottom : ""}`} style={{ fontWeight: 700 }}>{fvRow(r.col1)}</td>
              ...
              <tr>
                <td className={labelStyle} style={{ fontWeight: 700 }}>Total Partners' Capital — Income Tax Basis</td>
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fv("85,600", false, true)}</td>
                <td className={cellStyle}>{fv("60,600", false, true)}</td>
              </tr>

              <tr><td style={{ height: 4 }}></td><td></td><td></td>{showManual && <td></td>}</tr>

              <tr>
                <td className={`${labelStyle} ${thickBorderTop} ${thickBorderBottom}`} style={{ fontWeight: 700 }}>Total Liabilities and Partners' Capital</td>
                <td className={`${cellStyle} ${thickBorderTop} ${thickBorderBottom}`} style={{ fontWeight: 700 }}>{fv("164,300", false, true)}</td>
                <td className={`${cellStyle} ${thickBorderTop} ${thickBorderBottom}`}>{fv("141,900", false, true)}</td>
              </tr>
...
export default TemplatePartnershipTaxBalanceSheetPreview;
