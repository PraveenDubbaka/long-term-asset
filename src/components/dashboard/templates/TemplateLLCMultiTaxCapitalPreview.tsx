...
const TemplateLLCMultiTaxCapitalPreview = ({ isEditMode = false }: { isEditMode?: boolean }) => {
      ...
      >
        ...
        <div style={{ flex: 1, padding: bodyPadding, fontSize: baseFontSize, color: "#1a1a1a", position: "relative" }}>
          <div style={{ marginBottom: 18 }}>
            ...
            <div style={{ fontSize: 18 * scale, fontWeight: 700, marginBottom: 2 }}>
              <span style={{ background: isEditMode ? "hsl(220 15% 90%)" : "transparent", padding: "1px 6px", borderRadius: 2 }}>Statement of Changes in Members' Capital — Income Tax Basis</span>
            </div>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: baseFontSize }}>
            ...
            <tbody>
              {/* Opening Balance */}
              <tr>
                <td className={labelStyle} style={{ fontWeight: 700, paddingTop: 8 }}>Members' Capital, Beginning of Year (Tax Basis)</td>
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fvRow("46,500")}</td>
                <td className={cellStyle}>{fvRow("37,300")}</td>
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fvRow("83,800")}</td>
              </tr>
              ...
              <tr>
                ...
                <td className={`${cellStyle} ${borderBottom}`} style={{ fontWeight: 700 }}>{fvRow("34,430")}</td>
                <td className={`${cellStyle} ${borderBottom}`}>{fvRow("28,170")}</td>
                <td className={`${cellStyle} ${borderBottom}`} style={{ fontWeight: 700 }}>{fvRow("62,600")}</td>
              </tr>
              <tr>
                <td className={labelStyle} style={{ fontWeight: 700 }}>Total Additions</td>
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fv("42,430", false, true)}</td>
                <td className={cellStyle}>{fv("34,170", false, true)}</td>
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fv("76,600", false, true)}</td>
              </tr>
              ...
              <tr>
                ...
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fv("88,930", false, true)}</td>
                <td className={cellStyle}>{fv("71,470", false, true)}</td>
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fv("160,400", false, true)}</td>
              </tr>
              ...
              <tr>
                ...
                <td className={cellStyle}>{fvRow("16,000")}</td>
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fvRow("36,000")}</td>
              </tr>
              <tr>
                <td className={`${labelStyle} ${borderBottom}`} style={{ paddingLeft: 16 }}>Non-Deductible Expenses Allocated</td>
                <td className={`${cellStyle} ${borderBottom}`} style={{ fontWeight: 700 }}>{fvRow("6,730")}</td>
                <td className={`${cellStyle} ${borderBottom}`}>{fvRow("6,270")}</td>
                <td className={`${cellStyle} ${borderBottom}`} style={{ fontWeight: 700 }}>{fvRow("13,000")}</td>
              </tr>
              <tr>
                <td className={labelStyle} style={{ fontWeight: 700 }}>Total Deductions</td>
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fv("26,730", false, true)}</td>
                <td className={cellStyle}>{fv("22,270", false, true)}</td>
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fv("49,000", false, true)}</td>
              </tr>
              ...
              {/* Closing Balance */}
              <tr>
                <td className={`${labelStyle} ${thickBorderTop} ${thickBorderBottom}`} style={{ fontWeight: 700 }}>Members' Capital, End of Year (Tax Basis)</td>
                <td className={`${cellStyle} ${thickBorderTop} ${thickBorderBottom}`} style={{ fontWeight: 700 }}>{fv("62,200", false, true)}</td>
                <td className={`${cellStyle} ${thickBorderTop} ${thickBorderBottom}`}>{fv("49,200", false, true)}</td>
                <td className={`${cellStyle} ${thickBorderTop} ${thickBorderBottom}`} style={{ fontWeight: 700 }}>{fv("111,400", false, true)}</td>
              </tr>
            </tbody>
          </table>
        </div>
...
export default TemplateLLCMultiTaxCapitalPreview;
