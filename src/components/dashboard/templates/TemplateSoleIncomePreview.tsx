...
const TemplateSoleIncomePreview = ({ isEditMode = false }: { isEditMode?: boolean }) => {
      ...
      >
        ...
        <div style={{ flex: 1, padding: bodyPadding, fontSize: baseFontSize, color: "#1a1a1a", position: "relative" }}>
          <div style={{ marginBottom: 18 }}>
            ...
            <div style={{ fontSize: 18 * scale, fontWeight: 700, marginBottom: 2 }}>
              <span style={{ background: isEditMode ? "hsl(220 15% 90%)" : "transparent", padding: "1px 6px", borderRadius: 2 }}>Statement of Revenue and Expenses</span>
            </div>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: baseFontSize }}>
            ...
            <tbody>
              ...
              {[
                { label: "Sales Revenue", col1: "142,000", col2: "118,500" },
                { label: "Service Revenue", col1: "28,000", col2: "22,000" },
                { label: "Other Income", col1: "1,500", col2: "900" },
              ].map((r, i, arr) => (
                <tr key={i}>
              ...
              <tr>
                ...
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fv("171,500", false, true)}</td>
                <td className={cellStyle}>{fv("141,400", false, true)}</td>
              </tr>
              ...
              {[
                ...
                { label: "Purchases", col1: "62,000", col2: "51,000" },
              ...
              <tr>
                ...
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fv("60,700", false, true)}</td>
                <td className={cellStyle}>{fv("49,500", false, true)}</td>
              </tr>
              ...
              <tr>
                ...
                <td className={`${cellStyle} ${thickBorderTop}`} style={{ fontWeight: 700 }}>{fv("110,800", false, true)}</td>
                <td className={`${cellStyle} ${thickBorderTop}`}>{fv("91,900", false, true)}</td>
              </tr>
              ...
              {[
                { label: "Wages and Benefits", col1: "32,000", col2: "28,000" },
                { label: "Rent", col1: "18,000", col2: "18,000" },
                { label: "Utilities", col1: "4,800", col2: "4,200" },
                { label: "Office Supplies and Expenses", col1: "3,200", col2: "2,800" },
                { label: "Insurance", col1: "3,600", col2: "3,400" },
                { label: "Advertising and Promotion", col1: "5,500", col2: "4,000" },
                { label: "Motor Vehicle Expenses", col1: "4,200", col2: "3,800" },
                { label: "Amortization (Note 3)", col1: "6,500", col2: "5,800" },
                { label: "Interest on Long-Term Debt", col1: "2,400", col2: "3,000" },
              ...
              <tr>
                <td className={`${labelStyle} ${thickBorderTop}`} style={{ fontWeight: 700 }}>Total Operating Expenses</td>
                <td className={`${cellStyle} ${thickBorderTop}`} style={{ fontWeight: 700 }}>{fv("83,000", false, true)}</td>
                <td className={`${cellStyle} ${thickBorderTop}`}>{fv("75,500", false, true)}</td>
              </tr>
              ...
              {/* Net Income */}
              <tr>
                <td className={`${labelStyle} ${thickBorderTop} ${thickBorderBottom}`} style={{ fontWeight: 700 }}>Net Income for the Year</td>
                <td className={`${cellStyle} ${thickBorderTop} ${thickBorderBottom}`} style={{ fontWeight: 700 }}>{fv("27,800", false, true)}</td>
                <td className={`${cellStyle} ${thickBorderTop} ${thickBorderBottom}`}>{fv("16,400", false, true)}</td>
              </tr>
            </tbody>
          </table>
        </div>
...
export default TemplateSoleIncomePreview;
