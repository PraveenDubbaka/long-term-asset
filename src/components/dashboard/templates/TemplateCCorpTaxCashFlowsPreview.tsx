...
const TemplateCCorpTaxCashFlowsPreview = ({ isEditMode = false }: { isEditMode?: boolean }) => {
  ...
  const rows: Row[] = [
    ...
    { label: "Net Income — Income Tax Basis", col1: "188,020", col2: "132,720" },
    { label: "Adjustments:", col1: "", col2: "", bold: true },
    { label: "MACRS Depreciation", col1: "67,000", col2: "55,000", indent: 1 },
    { label: "Section 179 Deduction", col1: "15,000", col2: "12,000", indent: 1 },
    { label: "Section 197 Amortization", col1: "7,000", col2: "7,000", indent: 1 },
    { label: "Changes in Operating Assets and Liabilities:", col1: "", col2: "", bold: true, indent: 1 },
    { label: "Accounts Receivable", col1: "(40,000)", col2: "(30,000)", indent: 2 },
    { label: "Inventories", col1: "(15,000)", col2: "(10,000)", indent: 2 },
    { label: "Prepaid Expenses", col1: "(3,000)", col2: "1,000", indent: 2 },
    { label: "Accounts Payable", col1: "24,000", col2: "15,000", indent: 2 },
    { label: "Accrued Expenses", col1: "7,000", col2: "5,000", indent: 2 },
    { label: "Income Taxes Payable", col1: "6,000", col2: "4,000", indent: 2, bottomBorder: true },
    { label: "Net Cash Provided by Operating Activities", col1: "256,020", col2: "191,720", bold: true, topBorder: true, bottomBorder: true, thick: true, isTotal: true },

    { label: "Cash Flows from Investing Activities", col1: "", col2: "", bold: true, topBorder: true },
    { label: "Purchases of Property and Equipment", col1: "(30,000)", col2: "(45,000)", indent: 1 },
    { label: "Proceeds from Sale of Assets", col1: "15,000", col2: "-", indent: 1 },
    { label: "Purchases of Section 197 Intangibles", col1: "-", col2: "(8,000)", indent: 1, bottomBorder: true },
    { label: "Net Cash Used in Investing Activities", col1: "(15,000)", col2: "(53,000)", bold: true, topBorder: true, bottomBorder: true, thick: true, isTotal: true },

    { label: "Cash Flows from Financing Activities", col1: "", col2: "", bold: true, topBorder: true },
    { label: "Repayment of Long-Term Debt", col1: "(25,000)", col2: "(25,000)", indent: 1 },
    { label: "Dividends Paid", col1: "(150,020)", col2: "(80,000)", indent: 1, bottomBorder: true },
    { label: "Net Cash Used in Financing Activities", col1: "(175,020)", col2: "(105,000)", bold: true, topBorder: true, bottomBorder: true, thick: true, isTotal: true },

    { label: "Net Increase (Decrease) in Cash", col1: "66,000", col2: "33,720", bold: true, topBorder: true, isTotal: true },
    { label: "Cash and Cash Equivalents, Beginning of Year", col1: "98,000", col2: "64,280", bold: true },
    { label: "Cash and Cash Equivalents, End of Year", col1: "164,000", col2: "98,000", bold: true, topBorder: true, bottomBorder: true, thick: true, isTotal: true },
  ];
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: baseFontSize }}>
            ...
            <tbody>
              {rows.map((r, i) => (
                <tr key={i}>
                  <td
                    className={`${labelStyle} ${r.topBorder ? (r.thick ? thickBorderTop : borderTop) : ""} ${r.bottomBorder ? (r.thick ? thickBorderBottom : borderBottom) : ""}`}
                    style={{
                  ...
                  <td className={`${cellStyle} ${r.topBorder ? (r.thick ? thickBorderTop : borderTop) : ""} ${r.bottomBorder ? (r.thick ? thickBorderBottom : borderBottom) : ""}`} style={{ fontWeight: 700 }}>
                    {fvRow(r.col1, r.isTotal)}
                  </td>
                  <td className={`${cellStyle} ${r.topBorder ? (r.thick ? thickBorderTop : borderTop) : ""} ${r.bottomBorder ? (r.thick ? thickBorderBottom : borderBottom) : ""}`}>
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", fontSize: baseFontSize }}>
              <tbody>
                <tr>
                  ...
                  <td className={cellStyle} style={{ width: "22.5%", fontWeight: 700 }}>{fv("12,000")}</td>
                  <td className={cellStyle} style={{ width: "22.5%" }}>{fv("15,000")}</td>
                </tr>
                <tr>
                  <td className={labelStyle} style={{ paddingLeft: 16 }}>Cash Paid for Federal Income Taxes</td>
                  <td className={cellStyle} style={{ width: "22.5%", fontWeight: 700 }}>{fv("43,980")}</td>
                  <td className={cellStyle} style={{ width: "22.5%" }}>{fv("31,280")}</td>
                </tr>
                <tr>
                  <td className={labelStyle} style={{ paddingLeft: 16 }}>Cash Paid for State Income Taxes</td>
                  <td className={cellStyle} style={{ width: "22.5%", fontWeight: 700 }}>{fv("8,000")}</td>
                  <td className={cellStyle} style={{ width: "22.5%" }}>{fv("6,000")}</td>
                </tr>
              </tbody>
            </table>
          </div>
...
export default TemplateCCorpTaxCashFlowsPreview;
