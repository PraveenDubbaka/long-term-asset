...
const TemplateRetainedEarningsPreview = ({ isEditMode = false }: { isEditMode?: boolean }) => {
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: baseFontSize }}>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className={`${cellStyle} ${borderBottom}`} style={{ fontWeight: 700 }}>{fvRow("25,000")}</td>
                <td className={`${cellStyle} ${borderBottom}`}>{fvRow("20,000")}</td>
                {manualBorderCell(borderBottom)}
              </tr>
              <tr>
                <td className={labelStyle}></td>
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fv("75,000", false, true)}</td>
                <td className={cellStyle}>{fv("55,000", false, true)}</td>
                {manualCell()}
              </tr>
              ...
              {[
                { label: "Dividends Declared", col1: "10,000", col2: "5,000" },
              ].map((r, i, arr) => (
                <tr key={i}>
              ...
              <tr>
                <td className={labelStyle}></td>
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fv("10,000", false, true)}</td>
                <td className={cellStyle}>{fv("5,000", false, true)}</td>
                {manualCell()}
              </tr>
              ...
              <tr>
                ...
                <td className={`${cellStyle} ${thickBorderTop} ${thickBorderBottom}`} style={{ fontWeight: 700 }}>{fv("65,000", false, true)}</td>
                <td className={`${cellStyle} ${thickBorderTop} ${thickBorderBottom}`}>{fv("50,000", false, true)}</td>
...
export default TemplateRetainedEarningsPreview;
