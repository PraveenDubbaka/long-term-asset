...
const TemplateCCorpIncomePreview = ({ isEditMode = false }: { isEditMode?: boolean }) => {
      ...
      >
        ...
        <div style={{ flex: 1, padding: bodyPadding, fontSize: baseFontSize, color: "#1a1a1a", position: "relative" }}>
          <div style={{ marginBottom: 18 }}>
            ...
            <div style={{ fontSize: 18 * scale, fontWeight: 700, marginBottom: 2 }}>
              <span style={{ background: isEditMode ? "hsl(220 15% 90%)" : "transparent", padding: "1px 6px", borderRadius: 2 }}>Income Statement</span>
            </div>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: baseFontSize }}>
            ...
            <tbody>
              ...
              {[
                { label: "Net Sales", col1: "2,450,000", col2: "2,180,000" },
                { label: "Service Revenue", col1: "320,000", col2: "275,000" },
              ].map((r, i, arr) => (
                <tr key={i}>
              ...
              <tr>
                ...
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fv("2,770,000", false, true)}</td>
                <td className={cellStyle}>{fv("2,455,000", false, true)}</td>
              </tr>
              ...
              <tr>
                ...
                <td className={`${cellStyle} ${borderBottom}`} style={{ fontWeight: 700 }}>{fvRow("1,660,000")}</td>
                <td className={`${cellStyle} ${borderBottom}`}>{fvRow("1,490,000")}</td>
              </tr>

              <tr>
                <td className={labelStyle} style={{ fontWeight: 700 }}>Gross Profit</td>
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fv("1,110,000", false, true)}</td>
                <td className={cellStyle}>{fv("965,000", false, true)}</td>
              </tr>
              ...
              {[
                { label: "Salaries and Wages", col1: "425,000", col2: "390,000" },
                { label: "Employee Benefits", col1: "85,000", col2: "78,000" },
                { label: "Rent Expense", col1: "96,000", col2: "96,000" },
                { label: "Depreciation and Amortization", col1: "47,000", col2: "42,000" },
                { label: "Professional Fees", col1: "38,000", col2: "32,000" },
                { label: "Insurance", col1: "28,000", col2: "25,000" },
                { label: "Office Supplies and Expenses", col1: "18,000", col2: "15,000" },
                { label: "Utilities", col1: "22,000", col2: "20,000" },
                { label: "Advertising and Marketing", col1: "35,000", col2: "30,000" },
                { label: "Other Operating Expenses", col1: "16,000", col2: "12,000" },
              ].map((r, i, arr) => (
                <tr key={`oe-${i}`}>
                  <td className={`${labelStyle} ${i === arr.length - 1 ? borderBottom : ""}`} style={{ paddingLeft: 16 }}>{r.label}</td>
                  <td className={`${cellStyle} ${i === arr.length - 1 ? borderBottom : ""}`} style={{ fontWeight: 700 }}>{fvRow(r.col1)}</td>
              ...
              <tr>
                ...
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fv("810,000", false, true)}</td>
                <td className={cellStyle}>{fv("740,000", false, true)}</td>
              </tr>
              ...
              <tr>
                ...
                <td className={`${cellStyle} ${borderBottom}`} style={{ fontWeight: 700 }}>{fv("300,000", false, true)}</td>
                <td className={`${cellStyle} ${borderBottom}`}>{fv("225,000", false, true)}</td>
              </tr>
              ...
              {[
                { label: "Interest Income", col1: "5,000", col2: "3,000" },
                { label: "Interest Expense", col1: "(12,000)", col2: "(15,000)" },
                { label: "Gain on Sale of Assets", col1: "8,000", col2: "-" },
              ].map((r, i, arr) => (
                <tr key={`oi-${i}`}>
                  <td className={`${labelStyle} ${i === arr.length - 1 ? borderBottom : ""}`} style={{ paddingLeft: 16 }}>{r.label}</td>
                  <td className={`${cellStyle} ${i === arr.length - 1 ? borderBottom : ""}`} style={{ fontWeight: 700 }}>{fvRow(r.col1)}</td>
              ...
              <tr>
                ...
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fv("1,000", false, true)}</td>
                <td className={cellStyle}>{fv("(12,000)", false, true)}</td>
              </tr>

              <tr><td style={{ height: 6 }}></td><td></td><td></td>{showManual && <td></td>}</tr>

              <tr>
                <td className={labelStyle} style={{ fontWeight: 700 }}>Income Before Income Taxes</td>
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fv("301,000", false, true)}</td>
                <td className={cellStyle}>{fv("213,000", false, true)}</td>
              </tr>

              <tr>
                <td className={`${labelStyle} ${borderBottom}`}>Provision for Income Taxes</td>
                <td className={`${cellStyle} ${borderBottom}`} style={{ fontWeight: 700 }}>{fvRow("75,000")}</td>
                <td className={`${cellStyle} ${borderBottom}`}>{fvRow("53,000")}</td>
              </tr>

              <tr>
                <td className={`${labelStyle} ${thickBorderTop} ${thickBorderBottom}`} style={{ fontWeight: 700 }}>NET INCOME</td>
                <td className={`${cellStyle} ${thickBorderTop} ${thickBorderBottom}`} style={{ fontWeight: 700 }}>{fv("226,000", false, true)}</td>
                <td className={`${cellStyle} ${thickBorderTop} ${thickBorderBottom}`}>{fv("160,000", false, true)}</td>
              </tr>
              ...
              {/* EPS */}
              <tr>
                <td className={labelStyle} style={{ fontWeight: 700 }}>Earnings Per Share — Basic</td>
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fvRow("2.26")}</td>
                <td className={cellStyle}>{fvRow("1.60")}</td>
              </tr>
              <tr>
                <td className={labelStyle} style={{ fontWeight: 700 }}>Earnings Per Share — Diluted</td>
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fvRow("2.20")}</td>
                <td className={cellStyle}>{fvRow("1.56")}</td>
              </tr>
            </tbody>
          </table>
        </div>
...
export default TemplateCCorpIncomePreview;
