...
const TemplateCCorpBalanceSheetPreview = ({ isEditMode = false }: { isEditMode?: boolean }) => {
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: baseFontSize }}>
            ...
            <tbody>
              ...
              {[
                ...
                { label: "Accounts Receivable, Net", col1: "285,000", col2: "245,000" },
                { label: "Inventories", col1: "190,000", col2: "175,000" },
                { label: "Prepaid Expenses", col1: "22,000", col2: "18,000" },
              ].map((r, i, arr) => (
                <tr key={i}>
              ...
              <tr>
                ...
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fv("622,000", false, true)}</td>
                <td className={cellStyle}>{fv("536,000", false, true)}</td>
              </tr>
              ...
              {[
                ...
                { label: "Less: Accumulated Depreciation", col1: "(195,000)", col2: "(155,000)" },
              ].map((r, i, arr) => (
                <tr key={`ppe-${i}`}>
                  <td className={`${labelStyle} ${i === arr.length - 1 ? borderBottom : ""}`} style={{ paddingLeft: 32 }}>{r.label}</td>
                  <td className={`${cellStyle} ${i === arr.length - 1 ? borderBottom : ""}`} style={{ fontWeight: 700 }}>{fvRow(r.col1)}</td>
              ...
              <tr>
                ...
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fv("755,000", false, true)}</td>
                <td className={cellStyle}>{fv("765,000", false, true)}</td>
              </tr>
              ...
              {[
                { label: "Goodwill", col1: "50,000", col2: "50,000" },
                { label: "Other Intangible Assets, Net", col1: "35,000", col2: "42,000" },
              ].map((r, i) => (
                <tr key={`oth-${i}`}>
              ...
              <tr>
                ...
                <td className={`${cellStyle} ${thickBorderTop} ${thickBorderBottom}`} style={{ fontWeight: 700 }}>{fv("1,462,000", false, true)}</td>
                <td className={`${cellStyle} ${thickBorderTop} ${thickBorderBottom}`}>{fv("1,393,000", false, true)}</td>
              </tr>
              ...
              {[
                ...
                { label: "Accrued Expenses", col1: "68,000", col2: "55,000" },
                { label: "Income Taxes Payable", col1: "32,000", col2: "28,000" },
              ...
              <tr>
                ...
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fv("267,000", false, true)}</td>
                <td className={cellStyle}>{fv("226,000", false, true)}</td>
              </tr>
              ...
              {[
                ...
                { label: "Deferred Income Taxes", col1: "45,000", col2: "38,000" },
              ].map((r, i, arr) => (
                <tr key={`ltl-${i}`}>
              ...
              <tr>
                ...
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fv("512,000", false, true)}</td>
                <td className={cellStyle}>{fv("489,000", false, true)}</td>
              </tr>
              ...
              {[
                ...
                { label: "Retained Earnings", col1: "520,000", col2: "474,000" },
              ...
              <tr>
                ...
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fv("950,000", false, true)}</td>
                <td className={cellStyle}>{fv("904,000", false, true)}</td>
              </tr>
...
export default TemplateCCorpBalanceSheetPreview;
