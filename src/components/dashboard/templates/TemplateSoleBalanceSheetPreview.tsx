...
const TemplateSoleBalanceSheetPreview = ({ isEditMode = false }: { isEditMode?: boolean }) => {
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: baseFontSize }}>
            ...
            <tbody>
              ...
              {[
                ...
                { label: "Accounts Receivable", col1: "15,800", col2: "12,400" },
                { label: "Inventory", col1: "8,200", col2: "6,900" },
                { label: "Prepaid Expenses", col1: "2,100", col2: "1,800" },
              ].map((r, i, arr) => (
                <tr key={i}>
              ...
              <tr>
                ...
                <td className={cellStyle}>{fv("40,300", false, true)}</td>
              </tr>
              ...
              {[
                { label: "Equipment", col1: "45,000", col2: "40,000" },
                { label: "Motor Vehicle", col1: "32,000", col2: "32,000" },
                { label: "Less: Accumulated Amortization", col1: "(18,500)", col2: "(12,000)" },
              ].map((r, i, arr) => (
                <tr key={`ca-${i}`}>
                  <td className={`${labelStyle} ${i === arr.length - 1 ? borderBottom : ""}`} style={{ paddingLeft: 32 }}>{r.label}</td>
                  <td className={`${cellStyle} ${i === arr.length - 1 ? borderBottom : ""}`} style={{ fontWeight: 700 }}>{fvRow(r.col1)}</td>
              ...
              <tr>
                ...
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fv("58,500", false, true)}</td>
                <td className={cellStyle}>{fv("60,000", false, true)}</td>
              </tr>
              ...
              <tr>
                ...
                <td className={`${cellStyle} ${thickBorderTop} ${thickBorderBottom}`} style={{ fontWeight: 700 }}>{fv("113,100", false, true)}</td>
                <td className={`${cellStyle} ${thickBorderTop} ${thickBorderBottom}`}>{fv("100,300", false, true)}</td>
              </tr>
              ...
              <tr><td className={labelStyle} style={{ fontWeight: 700 }}>Proprietor's Capital</td><td className={cellStyle}></td><td className={cellStyle}></td>{emptyManualTd}</tr>
              {[
                { label: "Owner's Capital (Note 5)", col1: "71,500", col2: "55,500" },
              ].map((r, i, arr) => (
                <tr key={`eq-${i}`}>
                  <td className={`${labelStyle} ${i === arr.length - 1 ? borderBottom : ""}`} style={{ paddingLeft: 16 }}>{r.label}</td>
                  <td className={`${cellStyle} ${i === arr.length - 1 ? borderBottom : ""}`} style={{ fontWeight: 700 }}>{fvRow(r.col1)}</td>
              ...
              <tr>
                <td className={labelStyle} style={{ fontWeight: 700 }}>Total Proprietor's Capital</td>
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fv("71,500", false, true)}</td>
                <td className={cellStyle}>{fv("55,500", false, true)}</td>
              </tr>
...
export default TemplateSoleBalanceSheetPreview;
