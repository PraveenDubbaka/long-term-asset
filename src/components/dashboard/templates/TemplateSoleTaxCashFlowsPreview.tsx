...
const TemplateSoleTaxCashFlowsPreview = ({ isEditMode = false }: { isEditMode?: boolean }) => {
        ...
        <div style={{ flex: 1, padding: bodyPadding, fontSize: baseFontSize, color: "#1a1a1a", position: "relative" }}>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: baseFontSize }}>
            ...
            <tbody>
              ...
              <tr>
                <td className={labelStyle} style={{ paddingLeft: 16 }}>Net Business Income — Income Tax Basis</td>
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fvRow("27,100")}</td>
                <td className={cellStyle}>{fvRow("17,000")}</td>
              </tr>
              ...
              {[
                { label: "Capital Cost Allowance (CCA)", col1: "7,600", col2: "6,200" },
              ].map((r, i) => (
                <tr key={`adj-${i}`}>
              ...
              <tr>
                ...
                <td className={`${cellStyle} ${thickBorderTop} ${thickBorderBottom}`} style={{ fontWeight: 700 }}>{fv("32,500", false, true)}</td>
                <td className={`${cellStyle} ${thickBorderTop} ${thickBorderBottom}`}>{fv("21,500", false, true)}</td>
              </tr>
              ...
              {[
                { label: "Purchase of Capital Assets", col1: "(5,000)", col2: "(8,000)" },
              ].map((r, i, arr) => (
                <tr key={`inv-${i}`}>
              ...
              <tr>
                <td className={labelStyle} style={{ fontWeight: 700 }}>Net Increase (Decrease) in Cash</td>
                <td className={cellStyle} style={{ fontWeight: 700 }}>{fv("9,700", false, true)}</td>
              ...
              <tr>
                ...
                <td className={cellStyle}>{fvRow("20,700")}</td>
              </tr>
              <tr>
                <td className={`${labelStyle} ${thickBorderTop} ${thickBorderBottom}`} style={{ fontWeight: 700 }}>Cash and Cash Equivalents, End of Year</td>
                <td className={`${cellStyle} ${thickBorderTop} ${thickBorderBottom}`} style={{ fontWeight: 700 }}>{fv("28,900", false, true)}</td>
...
export default TemplateSoleTaxCashFlowsPreview;
